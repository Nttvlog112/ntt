...
MoonUI.TextLabel_39.Text = "Set JumpPower"
...
MoonUI.JumpBox_2.PlaceholderText = "Enter Jump Here"
...
MoonUI.SpeedBox_2.PlaceholderText = "Enter Speed Here"
...
MoonUI.TextLabel_40.Text = "Set WalkSpeed"
...
MoonUI.Title_28.Text = "Player UI"
...
MoonUI.TextLabel_47.Text = "Fly Mode (Press 'E')"
...
MoonUI.TextLabel_48.Text = "Execute"
...
MoonUI.Title_29.Text = "Executor UI"
...
MoonUI.TextLabel_49.Text = "Clear"
...
coroutine.wrap(AFIIFEN_fake_script)()
local function DNMXUXW_fake_script() -- MoonUI.Button1_3.LocalScript 
...
coroutine.wrap(DNMXUXW_fake_script)()
local function XKXECQ_fake_script() -- MoonUI.Button1_4.LocalScript 
...
coroutine.wrap(XKXECQ_fake_script)()
local function TYAT_fake_script() -- MoonUI.DescriptionPlayerText.LocalScript 
	local script = Instance.new('LocalScript', MoonUI.DescriptionPlayerText)

	script.Parent.Text = "Welcome".." "..game.Players.LocalPlayer.Name.."!!".." ".."Thank You For Using MoonUI!! :D"
end
coroutine.wrap(TYAT_fake_script)()
local function MVCUQ_fake_script() -- MoonUI.PlayerImage.Script 
...
local function YGTEE_fake_script() -- MoonUI.Open.LocalScript 
	...
	OpenBtn.MouseButton1Click:Connect(function (click)
		if MoonFrame.Visible == false then
			...
			script.Parent.TextLabel.Text = "Close"
		else
			MoonFrame.Visible = false
		script.Parent.TextLabel.Text = "Open"
		end
	end)
end
